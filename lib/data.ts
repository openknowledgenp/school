...
export const COURSES: Course[] = [
  {
    ...
    desc: "A structured curriculum on open-data concepts, sources and reuse. Covers what open data is, where to find it in Nepal, how to assess quality and licensing, and how to put it to use — paired with a compiled learner manual for self-study or group sessions.",
    level: "Beginner",
    modules: "4 modules",
  },
  {
  ...
  },
  {
    ...
    desc: "A four-module course covering fundamentals, collection and processing, analysis, and visualization and uptake of gender-disaggregated data. A Nepal-contextualised adaptation of the Ladysmith Gender Data 101 MOOC, built with Women Leaders in Technology and tested with women across Nepal.",
    level: "Intermediate",
    modules: "4 modules",
  },
  {
    ...
    color: "#717FDA",
    title: "Everyday AI",
    desc: "A bilingual four-phase curriculum covering what AI can and cannot do, prompting, AI safety, and the STOP, CHECK, ASK verification routine. Includes a practical toolkit with a prompt bank, data-protection do's and don'ts, and a verification checklist for everyday tasks.",
    level: "Beginner",
    modules: "4 modules",
  },
  {
    ...
    desc: "Practical habits to protect your accounts, devices and personal data online. Covers password hygiene, scam and phishing identification, safe use of eSewa and other Nepali fintech apps, online freedom of expression, privacy and data protection, and digital wellbeing.",
    level: "Beginner",
    modules: "3 modules",
  },
  {
  ...
  {
    tag: "Data · Local Government",
    color: "#717FDA",
    title: "Data and Digital Literacy for Local Government",
    desc: "A bilingual curriculum for local-government officers covering data management, digital tools and evidence-based decision-making. Includes training modules on the Integrated Data Management System (IDMS), data analysis, data usage and data stories.",
    level: "Beginner",
    modules: "Modular",
  },
  {
